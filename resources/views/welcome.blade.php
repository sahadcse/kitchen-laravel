            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        <li class="item" {{-- style="width: 30rem;" --}} id="{{ $item->category->slug }}">

                            <a href="#">
                                <img src="{{ asset('uploads/item/'. $item->image) }}" class="img-responsive img-fluid img-thumbnail" alt="Food" style="width: 29rem; height: 18rem;">
                                <div class="menu-desc align-text-top">
                                    <span>
                                        <h3>{{ $item->name }}</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        class="form-control reserve-form empty iconified" id="email" placeholder="  &#xf1d8;  e-mail">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    class="form-control reserve-form empty iconified" id="message" rows="3" placeholder="  &#xf086;  We're listening"></textarea>
                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        All Right Reserved &copy; Copyright, 2020 Developed by MD SAHADUZZAMAN <a href="http://sahaduzzaman.gq/" target="_blank"> -KPI</a>
                    </p>
                </div>
            </div>
        </div>
